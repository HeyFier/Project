...
#define  RC522_MOSI   PAout(4)
#define  RC522_MISO   PAin(5)
#define  RC522_SCK    PAout(3)


//
//定义MFRC522的CS引脚操作，x=1时CS=1，x=0时CS=0
#define MFRC522_CS(x) 	x ? GPIO_SetBits(GPIOA,GPIO_Pin_2):GPIO_ResetBits(GPIOA,GPIO_Pin_2)
#define MFRC522_Rst(x) 	x ? GPIO_SetBits(GPIOA,GPIO_Pin_6):GPIO_ResetBits(GPIOA,GPIO_Pin_6)
/////////////////////////////////////////////////////////////////////
//MF522命令字
/////////////////////////////////////////////////////////////////////
